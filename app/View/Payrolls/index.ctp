<div class="payrolls index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('payrolldate'); ?></th>
	...
	<tr>
		...
		<td><?php echo CakeTime::format($payroll['Payroll']['payrolldate'], '%B %e, %Y '); ?>&nbsp;</td>
		<td><?php echo h($payroll['Payroll']['comission']); ?>&nbsp;</td>
		<td><?php echo h($payroll['Payroll']['saving']); ?>&nbsp;</td>
		<td><?php echo h($payroll['Payroll']['bonus']); ?>&nbsp;</td>
		<td><?php echo h($payroll['Payroll']['advance']); ?>&nbsp;</td>
